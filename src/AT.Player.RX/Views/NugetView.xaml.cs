namespace AT.Player.RX.Views
{
    ...
    public partial class NugetView : ReactiveUserControl<NugetViewModel>
    {
        public NugetView()
        {
            ...
            // We create our bindings here. These are the code behind bindings which allow type
            // safety. The bindings will only become active when the Window is being shown. We
            // register our subscription in our disposableRegistration, this will cause the binding
            // subscription to become inactive when the Window is closed. The disposableRegistration
            // is a CompositeDisposable which is a container of other Disposables. We use the
            // DisposeWith() extension method which simply adds the subscription disposable to the CompositeDisposable.
